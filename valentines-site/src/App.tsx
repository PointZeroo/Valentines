...
function App() {
  ...
  return (
    <div className="container">
      {page === 1 && (
        <div className="page">
          <img src="/src/assets/Page1.gif" alt="Page 1" className="page-gif" />
          <h1>Yooooooo!</h1>
      ...
      {page === 2 && (
        <div className="page">
          <img src="/src/assets/Page2.gif" alt="Page 2" className="page-gif" />
      ...
      {page === 3 && (
        <div className="page">
          <img src="/src/assets/Page3.gif" alt="Page 3" className="page-gif" />
      ...
      {page === 4 && (
        <div className="page">
          <img src="/src/assets/Page4.gif" alt="Page 4" className="page-gif" />
      ...
      {page === 5 && (
        <div className="page">
          <img src="/src/assets/Page5.gif" alt="Page 5" className="page-gif" />
      ...
      {page === 6 && (
        <div className="page">
          <img src="/src/assets/Page6.gif" alt="Page 6" className="page-gif" />
      ...
      {page === 7 && (
        <div className="page">
          <img src="/src/assets/Page7.gif" alt="Page 7" className="page-gif" />
          <h1>Anyway...</h1>
      ...
      {page === 8 && (
        <div className="page">
          <img src="/src/assets/Page8_9.gif" alt="Page 8" className="page-gif" />
      ...
      {page === 9 && (
        <div className="page">
          <img src="/src/assets/Page8_9.gif" alt="Page 9" className="page-gif" />
      ...
      {page === 10 && (
        <div className="page">          <img src="/src/assets/Page10.gif" alt="Page 10" className="page-gif" />          <h1>Happy Valentine’s Day Shaina!❤️</h1>
        </div>
      )}
    </div>
  );
